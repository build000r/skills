...
def build_prompt(
    ...
    return dedent(f"""\
        ...
        - Dimension 4 (Test Payload Completeness): Test scenarios need expected status + error code + outcome description. Full JSON request/response bodies are ideal but outcome-level scenarios (e.g., "Happy: patient books → 201, booking confirmed, allotment decremented") are acceptable and should score 7-8/10, not 3-4/10.
