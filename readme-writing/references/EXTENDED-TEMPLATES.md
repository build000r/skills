...
For projects with strategic depth that exceeds what a README should carry. Created after competitive landscape research surfaces real positioning nuance.

```markdown
# Vision

This document captures the strategic thesis behind `project-name`: what it is
for, what it is not for, and why it exists despite adjacent tools that already
solve other parts of the problem.

## Mission

[One sentence. What does this project make possible for its users?]

## Vision

[2-3 sentences. The long-term shape this project is growing toward. Not a
feature list — a statement about what kind of tool this should be.]

## Values

### 1. [Value name]

[What this means in practice. Not an abstract platitude — a design constraint
that has caused you to say "no" to specific features.]

### 2. [Value name]

[Same pattern. Each value should be testable: "did this decision honor value N?"]

## The Wedge

The defensible wedge is not "[broad category]" in general.

The wedge is:

> [One sentence describing the specific gap this project fills, stated as a
> user need rather than a feature list.]

That sits between [N] established buckets:

- [Bucket 1]: [examples] — [what they do well]
- [Bucket 2]: [examples] — [what they do well]
- [Bucket 3]: [examples] — [what they do well]

`project-name` exists for the case where all buckets are close but none is a
clean fit.
...
- [User type who should use Competitor A instead]
- [User type who should use Competitor B instead]
- [User type whose needs exceed this project's scope]

## Competitive Fit

| Category | Examples | What they do well | Why they do not replace this project |
|----------|----------|-------------------|--------------------------------------|
| [Cat 1] | [repos] | [honest strength] | [specific gap] |
| [Cat 2] | [repos] | [honest strength] | [specific gap] |
| [Cat 3] | [repos] | [honest strength] | [specific gap] |

## Market Map

Axes:

- `X`: [axis name — e.g., platform heft]
- `Y`: [axis name — e.g., agent-native focus]

[ASCII chart plotting this project against comparables. See COMPETITIVE-LANDSCAPE.md
for the template.]

## Evidence From Comparable Repos

[Issue signals pulled with `gh` on a specific date. Group by theme.]

### 1. [Theme from issues]

- [owner/repo#N](url): [issue title or summary]
- [owner/repo#N](url): [issue title or summary]

Takeaway: [what this evidence means for this project's positioning].
...
These are tools and libraries this project should compose with rather than rebuild:

| Tool | What it does well | How this project should use it |
|------|-------------------|-------------------------------|
| [Tool A] | [strength] | [integration path] |
| [Tool B] | [strength] | [integration path] |

## Strategic Non-Goals

`project-name` should not become:

- [thing Competitor A already does well]
- [scope expansion that would require platform-level resources]
- [category that contradicts the values above]

## Product Test

New work should pass a simple filter:

- Does this make [core value proposition] better?
- Or does it drag the project toward [anti-pattern]?

If the answer looks more like [Competitor A/B/C] than `project-name`, the
burden of proof should be high.
```
