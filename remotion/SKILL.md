...
All Remotion projects can aggregate into a shared hub via symlinks. Configure a local `videos_hub_path` and run `npm run studio` there to preview all compositions. See [rules/project-hub.md](rules/project-hub.md) for architecture details.
