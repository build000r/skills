...
**Exception**: README.md for GitHub publishing (for human discoverability, not for Claude). See `references/publishing.md`.
...
Keep SKILL.md under 500 lines. Split to reference files when approaching this limit. Reference them clearly from SKILL.md so Claude knows they exist and when to use them.
...
When a user asks about sales, Claude only reads `sales.md`. Same pattern works for framework variants (aws.md, gcp.md, azure.md).
