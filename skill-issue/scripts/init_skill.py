...
def init_skill(skill_name, path, minimal=False):
    ...
    Args:
        ...
        minimal: If True, create a lean template without example files
    ...
    template = MINIMAL_SKILL_TEMPLATE if minimal else SKILL_TEMPLATE
    ...
    # Create resource directories with example files (skip for minimal)
    if not minimal:
        try:
    ...
    print("\nNext steps:")
    if minimal:
        print("1. Edit SKILL.md - update description and add instructions")
...
def main():
    if len(sys.argv) < 4 or sys.argv[2] != '--path':
        ...
        print("\nOptions:")
        print("  --minimal    Create a lean template without example files")
        print("\nExamples:")
    ...
    if minimal:
        print("   Mode: minimal (no example files)")
    print()
